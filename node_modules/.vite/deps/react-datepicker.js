...
function Oe(e3, t3, r2, n, o) {
  ...
  }), a3) : (a3 = parse(e3, t3, new Date(), { locale: s3 }), n ? i2 = Te(a3) && e3 === Ie(a3, t3, r2) : Te(a3) || (t3 = t3.match(xe).map(function(e4) {
    var t4 = e4[0];
    return "p" === t4 || "P" === t4 ? s3 ? (0, Ne[t4])(e4, s3.formatLong) : t4 : e4;
  }).join(""), e3.length > 0 && (a3 = parse(e3, t3.slice(0, e3.length), new Date())), Te(a3) || (a3 = new Date(e3))), Te(a3) && i2 ? a3 : null);
}
function Te(e3, t3) {
