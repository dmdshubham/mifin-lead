...
// node_modules/chartjs-chart-funnel/build/index.js
function inBetween(v, min6, max6, delta = 1e-5) {
  return v >= Math.min(min6, max6) - delta && v <= Math.max(min6, max6) + delta;
}
...
var TrapezoidElement = class extends BarElement {
  constructor() {
    super(...arguments);
    this.align = "center";
    this.next = void 0;
...
function pickForegroundColorToBackgroundColor(color, blackColor = "#000000", whiteColor = "#ffffff") {
  return chroma_js_default(color).luminance() > 0.5 ? blackColor : whiteColor;
}
function blues(i, n) {
  return chroma_js_default.scale("Blues")(i / (n - 1)).hex();
}
...
var FunnelController = class extends BarController {
  getMinMax(scale, canStack) {
    const { max: max6 } = super.getMinMax(scale, canStack);
    const r = {
      center: { min: -max6, max: max6 },
      left: { min: 0, max: max6 },
      right: { min: -max6, max: 0 }
    }[this.options.align];
    return r;
  }
  update(mode) {
...
var FunnelChart = class extends Chart {
...
export {
  ...
  TrapezoidElement,
  blues,
  pickForegroundColorToBackgroundColor
};
/**
 * @license
 *
 ...
 */
//# sourceMappingURL=chartjs-chart-funnel.js.map
